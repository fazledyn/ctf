...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if (($password == $cpassword) && $exists == false){
		$sql = "INSERT INTO `table_users` (`username`, `password`) VALUES ('$username', '$password');";
...
<head>
	...
	<title>Secret challange | signup</title>
				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							<h1 class="fs-4 card-title fw-bold mb-4 text-center">Signup From Here</h1>
							<form method="POST" action="/signup.php" class="needs-validation" id="fmdata">
								<div class="mb-3">
                                ...
                                <div class="mb-3">
									...
									<input id="text" type="password" class="form-control" name="cpassword" value="" required autofocus>
								</div>
